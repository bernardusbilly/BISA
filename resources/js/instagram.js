	...
	for (var i=0; i<INSTAGRAM_MAX_PHOTOS; i++) {
		if (i%IMAGE_PER_CAROUSEL == 0) {
			$(".carousel-inner").append("<div class='item'>\
				...
				<img src='" + data.data[i].images.standard_resolution.url + "' class='col-lg-3 col-md-4 col-sm-12 col-xs-12 photo-instagram' data-toggle='modal' data-target='#photo-modal'>\
				</div>\
				</div>");
